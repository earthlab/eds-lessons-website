...
## 1 283080… 11689430… 2019-09-03 17:45:23 OpenMarket… "Pub… Twitt…
## 2 244640… 11689428… 2019-09-03 17:44:25 TiffanyTim… "On … Twitt…
## 3 106314… 11689426… 2019-09-03 17:43:49 jimmy_gott  "Pub… ELK_B…
...
##   user_id status_id created_at          screen_name text  source
##   <chr>   <chr>     <dttm>              <chr>       <chr> <chr> 
## 1 244640… 11689428… 2019-09-03 17:44:25 TiffanyTim… "On … Twitt…
## 2 935569… 11689417… 2019-09-03 17:40:13 tidyverset… How … tidyv…
## # … with 84 more variables: display_text_width <dbl>,
## #   reply_to_status_id <chr>, reply_to_user_id <chr>,
## #   reply_to_screen_name <chr>, is_quote <lgl>, is_retweet <lgl>,
## #   favorite_count <int>, retweet_count <int>, quote_count <int>,
...
## [1] "TiffanyTimbers"  "tidyversetweets" "tidyversetweets" "tidyversetweets"
## [5] "tidyversetweets" "tidyversetweets"
# get a list of unique usernames
unique(rstats_tweets$screen_name)
##   [1] "TiffanyTimbers"  "tidyversetweets" "Rbloggers"      
##   [4] "rfortherest"     "gp_pulipaka"     "rocitations"    
##   [7] "mircaze"         "BiophysicalEco"  "CRANberriesFeed"
##  [10] "dataandme"       "hrbrmstr"        "thanhtungmilan" 
##  [13] "_DaniellaMark"   "tylermorganwall" "CougRstats"     
##  [16] "StatsForBios"    "ProCogia"        "RLadiesFreiburg"
##  [19] "DogmaticPrior"   "pachamaltese"    "TheMelton"      
##  [22] "DethWench"       "EarthLabCU"      "_Gil_Henriques" 
##  [25] "joranelias"      "RLadiesLancs"    "SeeHerGo"       
##  [28] "DataCamp"        "BodoWinter"      "Simmie_kafaru"  
##  [31] "RSSAnnualConf"   "DataDaft"        "LPMKremer"      
##  [34] "whiskersedge"    "maxheld"         "jonkeane"       
##  [37] "zdw2126062"      "ludmila_janda"   "davidhughjones" 
##  [40] "Eduardo50935627" "GrantHumphries"  "rstatsdc"       
##  [43] "ryanlinnbrown"   "abresler"        "SHaymondSays"   
##  [46] "geokaramanis"    "MikeRSpencer"    "Niels_Bremen"   
##  [49] "AmJEpi"          "ariel_esteban"   "JoaoGranja3"    
##  [52] "robsalasco"      "AlexSlavenko"    "AvrahamAdler"   
##  [55] "rmflight"        "planetmoney"     "nikki_g_b"      
##  [58] "levalencia"      "KinseyTedford"   "liz_mauer"      
##  [61] "gavg712"         "tishaevite"      "olyerickson"    
##  [64] "jessenleon"      "jimhester_"      "AnalyticsFrance"
##  [67] "cypher_text"     "DataScientistsF" "BigData_Fr"     
##  [70] "lobrowR"         "ingorohlfing"    "imsonoshah"     
##  [73] "KKulma"          "rfindingyourway" "underdarkGIS"   
##  [76] "chrisBowdata"    "JenniferBadham"  "rusersoxford"   
##  [79] "M_E_Scott"       "haematobot"      "LucyStats"      
##  [82] "mdancho84"       "MalariaAtlas"    "sharon000"      
##  [85] "gavin_fay"       "Ektropos"        "fatma_cinar_ftm"
##  [88] "dataclaudius"    "DerFredo"        "krystian8207"   
##  [91] "simon_tarr"      "evalparse"       "sherajilir"     
##  [94] "NumFOCUS"        "UK_PetDogPop"    "HiDefSurvey"    
##  [97] "perspectivalean" "Laserhedvig"     "tgwilson"       
## [100] "D_Rodziewicz"    "martinjhnhadley" "traffordDataLab"
## [103] "MazdakS"         "ClaireCities"    "shermstats"     
## [106] "THEAdamGabriel"  "veabrunsdon"     "niken59904793"  
## [109] "alexyfyf"        "datawookie"      "natedayta"      
## [112] "Vebash"          "KirkDBorne"      "RLangPackage"   
## [115] "Westlake_CJW"    "man_matej"       "howard_baik"    
## [118] "dtoher"          "StephenEglen"    "Altea_Lorenzo"  
## [121] "R_by_Ryo"        "appsilon"        "whatsgoodio"    
## [124] "jamie_lendrum"   "rweekly_live"    "DubelMarcin"    
## [127] "trappedalien"    "GSwithR"         "gbganalyst"     
## [130] "oscar_b123"      "josh_longbottom" "SamPlayle"      
## [133] "erbiostat"       "cleris_mr"       "earlconf"       
## [136] "fgutowski__"     "nj_tierney"      "whyRconf"       
## [139] "dinga92"         "RLadiesCapeTown" "CareQualityComm"
## [142] "datasciencetip1" "econabstracts"   "thegymnosophist"
## [145] "inesz"           "EmRstats"        "LucaLeisten"    
## [148] "ConallOM"        "ElzbthMcCrthy"   "thinkR_fr"      
## [151] "neilfws"         "LeahAWasser"     "aliyaleigh"     
## [154] "johnjanuszczak"  "obergr"          "rstudio"        
## [157] "technocrat"      "spoonertaylor"   "RLadiesSydney"  
## [160] "CurtinIC"        "_davecooley"     "consimption"    
## [163] "DerriereLaLune"  "daily_r_sheets"  "DeborahPassey"  
## [166] "d_olivaw"        "devenwisner"     "tangming2005"   
## [169] "DrAndrewRate"    "mrtec_y"         "NerdoRican"     
## [172] "tsonika"         "thomas_mock"     "AnnaHenschel"   
## [175] "SpacePlowboy"    "redheadkristy"   "alejdiazd"      
## [178] "gjmount"         "PaobCorrales"    "_lazappi_"      
## [181] "mbtoomey"        "Eeysirhc"        "brad_weiner"    
## [184] "MihiretuKebede1" "IKosmidis_"      "bek_grieger"    
## [187] "claudiodanielpc" "adamhsparks"     "leon_is_awesome"
## [190] "ai_korg"         "aschinchon"      "_sharleen_w"    
## [193] "BC0808"          "atrfisch"        "ChasingMicrobes"
## [196] "mikkelkrogsholm" "darrenclinch"    "Bluelion0305"   
## [199] "rhetta_chappell" "mixOmics_team"   "wendtke"        
## [202] "GuyProchilo"     "janellehajjar"   "NabaHassan8"    
## [205] "thomasp85"       "mattdray"        "wisevis"        
## [208] "felipe_mattioni" "DrPaulEllis"     "kai_arzheimer"  
## [211] "quantargo"       "la_Rusers"       "rstatsdata"     
## [214] "mkuehn10"        "CourseGift"      "ZKamvar"        
## [217] "vladtarko"       "kamromero"       "KristenNolting" 
## [220] "ottofwagner"     "mikedecr"        "adhdoug"        
## [223] "ethantenison"    "DanielT_W"       "RLangTip"       
## [226] "TeebzR"          "researchcommunK" "inesblackh"     
## [229] "_RCharlie"       "generativist"    "barbalhofernand"
## [232] "thomas_barto"    "jonathandinu"    "TazPoltorak"    
## [235] "scottyanco"      "JanaJarecki"     "LNPP_MX"        
## [238] "seabbs"          "McKibbinUSA"     "threader_app"   
## [241] "gdeandajauregui" "eddelbuettel"    "ariamsita"      
## [244] "datascienceplus" "mbeckett_za"     "JackkStat"      
## [247] "pegleraj"        "jladata"         "abiyugiday"     
## [250] "cai_sadio"       "juneyeungchun"   "ryantimpe"      
## [253] "YBirchPsy"       "koen_hufkens"    "_ColinFay"      
## [256] "SangerCytometry" "SwampThingPaul"  "jtrecenti"      
## [259] "MiguelCos"       "rmagn0"          "shamindraas"    
## [262] "bradisbrad"      "TraineeGeek"     "callmeyvan"     
## [265] "LessCrime"       "AlexisLNorris"   "FionaIngleby"   
## [268] "statwonk"        "Nate__Haines"    "wiscostretford" 
## [271] "JRBerrendero"    "TheGinaGi"       "AndreaCirilloAC"
## [274] "coolbutuseless"  "lapply"          "krishanu_c"     
## [277] "cosminribo"      "suuz_beck"       "RLadiesEdinb"   
## [280] "dirk_sch"        "pawel_appsilon"  "musy_n"         
## [283] "JLRohmann"       "MangoTheCat"     "notanastronomer"
## [286] "olga_mie"        "NeptuneML"       "BorisBeranger"  
## [289] "bobehayes"       "TripathiAm3"     "joe_diodato"    
## [292] "_J_sinclair"     "GTRao"           "RoelandtN42"    
## [295] "RPanczak"        "tymwol"          "SuperCroup"     
## [298] "potterzot"       "jspairani"
```
...
##   user_id status_id created_at          screen_name text  source
##   <chr>   <chr>     <dttm>              <chr>       <chr> <chr> 
## 1 101181… 11689371… 2019-09-03 17:21:44 rstatstweet New … rstat…
## 2 107501… 11689386… 2019-09-03 17:27:55 rstats4ds   New … R sta…
## # … with 84 more variables: display_text_width <dbl>,
## #   reply_to_status_id <chr>, reply_to_user_id <chr>,
## #   reply_to_screen_name <chr>, is_quote <lgl>, is_retweet <lgl>,
## #   favorite_count <int>, retweet_count <int>, quote_count <int>,
