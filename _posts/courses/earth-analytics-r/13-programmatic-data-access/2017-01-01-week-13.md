...
```
## Error in data.frame(date_time = boulder_flood_tweets$created_at, username = boulder_flood_tweets$user$screen_name, : object 'boulder_flood_tweets' not found
## Error in eval(expr, envir, enclos): object 'tweet_data' not found
## Error in eval(expr, envir, enclos): object 'flood_tweets' not found
## Error in eval(expr, envir, enclos): object 'flood_tweet_clean' not found
```
...
## Error in data.frame(date_time = boulder_flood_tweets$created_at, username = boulder_flood_tweets$user$screen_name, : object 'boulder_flood_tweets' not found
## Error in eval(expr, envir, enclos): object 'tweet_data' not found
## Error in eval(expr, envir, enclos): object 'flood_tweet_locations' not found
```
...
<img src="{{ site.url }}/courses/earth-analytics-r/03-lidar-raster-data/lidar-raster-intro/male-population-1.png" title="Male population ages 60-80." alt="Male population ages 60-80." width="90%" /><img src="{{ site.url }}/courses/earth-analytics-r/13-programmatic-data-access/male-population-1.png" title="Male population ages 60-80." alt="Male population ages 60-80." width="90%" />
