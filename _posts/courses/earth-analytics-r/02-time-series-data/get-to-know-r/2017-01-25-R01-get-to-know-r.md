...
<img src="{{ site.url }}/images/courses/earth-analytics-r/02-time-series-data/get-to-know-r/open-file-1.png" title="precip data plot" alt="precip data plot" width="90%" />
