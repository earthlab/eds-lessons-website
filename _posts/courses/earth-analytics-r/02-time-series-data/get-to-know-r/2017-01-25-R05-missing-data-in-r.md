...
download.file("https://ndownloader.figshare.com/files/9282364",
              "data/precipboulderaugoct2013-2.csv",
              method = "libcurl")
```
...
boulder_precip <- read.csv(file = "data/precipboulderaugoct2013-2.csv")
...
boulder_precip_na <- read.csv(file = "data/precipboulderaugoct2013-2.csv",
                     na.strings = c("NA", " ", "-999"))
